        ...
        <div class="flex items-center justify-center px-20 py-12 md:w-full">
          <div class="w-full">
            ...
            <div class="flex items-center space-x-2 justify-center mb-12 text-sm">
              ...
              <Link href="/register" class="font-medium hover:underline">Create New Account</Link>
            </div>
              ...
              <div class="flex items-center justify-between mb-6">
                <div class="flex items-center">
                  <div class="flex items-center h-5">
                    <input v-model="form.remember" id="remember-me" type="checkbox"
                      class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800" />
                  </div>
                  <label for="remember-me" class="ml-2 text-sm font-medium text-[#1E1E3C]">Remember Me</label>
                </div>
              </div>
