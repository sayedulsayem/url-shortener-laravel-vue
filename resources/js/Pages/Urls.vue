          ...
          <tbody id="the-tokens" class="text-sm font-normal text-gray-700">
            <tr class="border-b border-gray-200 py-10">
              <td class="px-4 py-3 plugin-title column-primary" width="40%">
                <span class="text-gray-600">https://sayem.dev.eazypluginmanager.com</span>
              </td>
              <td class="px-4 py-3 column-description desc">
                <div class="plugin-description text-gray-600 flex justify-start items-center">
                  <span>48d9995c83968e63d3e5c41c0bc9551d</span><a href="#"
                    class="ml-4 text-gray-400 relative flex flex-col items-center group focus:ring-0"><svg
                    ...
                    <div class="absolute bottom-0 flex-col items-center hidden mb-6 group-hover:flex">
                      <span
                        class="relative z-10 p-2 text-xs text-white bg-black whitespace-nowrap rounded-md">Copy</span>
              ...
              <td class="px-4 py-3 column-auto-updates flex justify-start items-center">
                <span class=""><button
                    class="text-white bg-green-500 border-0 mr-4 px-4 focus:outline-none hover:bg-green-600 rounded py-1"
                    style="display: none">
                    Activate
                  </button></span><a href="#"
                  class="ml-4 text-gray-400 hover:text-[#D54752] relative flex flex-col items-center group"><svg
                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
