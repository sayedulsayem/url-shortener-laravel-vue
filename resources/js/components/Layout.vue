      ...
      <ul class="flex flex-col flex-grow px-2 py-4 overflow-auto">
        <li>
          <Link
            ...
            :class="$page.url == '/' ? 'bg-white text-[#1E1E3C]' : 'text-white'"
          >
            <div class="flex items-center">
              <span class="w-4 h-4" v-html="icons.dashboard"></span
              ><span class="text-[15px] ml-2">Dashboard</span>
            </div>
          </Link>
        </li>
        <li>
          <Link
            ...
            class="p-2.5 mt-2 flex items-center justify-between rounded-md px-4 duration-300 hover:bg-white hover:text-[#1E1E3C]"
            :class="
              $page.url == '/urls' ? 'bg-white text-[#1E1E3C]' : 'text-white'
            "
          >
            <div class="flex items-center">
              <span class="w-4 h-4" v-html="icons.urls"></span
              ><span class="text-[15px] ml-2">Urls</span>
            </div>
          </Link>
        </li>
        <li>
          <Link
            ...
            class="p-2.5 mt-2 flex items-center justify-between rounded-md px-4 duration-300 hover:bg-white hover:text-[#1E1E3C]"
            :class="
              $page.url == '/profile' ? 'bg-white text-[#1E1E3C]' : 'text-white'
            "
          >
            <div class="flex items-center">
              <span class="w-4 h-4" v-html="icons.profile"></span
              ><span class="text-[15px] ml-2">Profile</span>
            </div>
          </Link>
        </li>
        <li>
          ...
          >
            <div class="flex items-center">
              <span class="w-4 h-4" v-html="icons.logout"></span
              ><span class="text-[15px] ml-2">Logout</span>
            </div>
          </Link>
        </li>
      </ul>
      ...
      <div class="flex items-center flex-shrink-0 h-16 px-6 bg-[#F3F3F6]">
        ...
        <div class="flex items-center ml-auto">
          <div class="ml-auto text-right">
            ...
            <span
              class="flex text-[12px] items-center space-x-1 text-[#B9B9B9]"
          ...
          <img
            ...
            alt="User Avatar"
            class="w-7 h-7 rounded-full bg-gray-500 ml-3 mr-2"
          />
        </div>
      </div>
